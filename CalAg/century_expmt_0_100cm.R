...
tiff(file = file.path(FiguresDir, 'ltras_0_100cm', 'soilC_change_ltras_fig_a.tif'), family = 'Times New Roman', width = 3.5, height = 4, pointsize = 12, units = 'in', res=800, compression='lzw')
par(mar=c(3.5,3.5,0.1,0.1))
plot(soilC_1993_means['OMT',], -depths, type='b', xlim=c(0.53,1.4), col='tan4', yaxt='n', ylab='', xlab='', lty=2, pch=1, cex=cex.setting)
axis(side = 2, at=-c(0,15,30,60,100), labels=c(0,15,30,60,100))
mtext('Depth (cm)', 2, 2.25)
mtext('Soil organic carbon (%)', 1, 2.25)
lines(soilC_2012_means['OMT',], -depths, type='b', col='tan4', pch=16, cex=cex.setting)
lines(soilC_1993_means['CMT',], -depths, type='b', col='deepskyblue', pch=2, lty=2, cex=cex.setting)
lines(soilC_2012_means['CMT',], -depths, type='b', pch=17, col='deepskyblue', cex=cex.setting)
lines(soilC_1993_means['LMT',], -depths, type='b', col='chartreuse4', pch=0, lty=2, cex=cex.setting)
lines(soilC_2012_means['LMT',], -depths, type='b', pch=15, col='chartreuse4', cex=cex.setting)
...
text(x=0.57, y=-15, labels = 'a')
points(x=0.93,y=-52, pch=1, cex=1.1)
text(x=1.02,y=-49, labels="significant change\nafter 19 yrs.", adj=c(0,1), cex=0.85)
...
plot(soilC_1993_means['RWF',], -depths, type='b', xlim=c(0.53,1.05), col='springgreen4', yaxt='n', ylab='', xlab='', lty=2, pch=1, cex=cex.setting)
#axis(side = 2, at=-c(0,15,30,60,100), labels=c(0,15,30,60,100))
#mtext('Depth (cm)', 2, 2.25)
mtext('Soil organic carbon (%)', 1, 2.25)
lines(soilC_2012_means['RWF',], -depths, type='b', col='springgreen4', pch=16, cex=cex.setting)
lines(soilC_1993_means['RWC',], -depths, type='b', col='red3', pch=6, lty=2, cex=cex.setting)
lines(soilC_2012_means['RWC',], -depths, type='b', pch=25, col='red3', bg='red3', cex=cex.setting)
lines(soilC_1993_means['RWL',], -depths, type='b', col='darkorange1', pch=5, lty=2, cex=cex.setting)
lines(soilC_2012_means['RWL',], -depths, type='b', pch=23, col='darkorange1', bg='darkorange1', cex=cex.setting)
...
par(mar=c(3.5,0.1,0.1,0.1))
plot(soilC_1993_means['IWF',], -depths, type='b', xlim=c(0.53,1.05), col='royalblue4', yaxt='n', ylab='', xlab='', lty=2, pch=2, cex=cex.setting)
#axis(side = 2, at=-c(0,15,30,60,100), labels=c(0,15,30,60,100))
#mtext('Depth (cm)', 2, 2.25)
mtext('Soil organic carbon (%)', 1, 2.25)
lines(soilC_2012_means['IWF',], -depths, type='b', pch=17, col='royalblue3', cex=cex.setting)
...
#test
soilC_0_15_1993[soilC_0_15_1993$Treatment=='RWC',]
soilC_0_15_2012[soilC_0_15_2012$Treatment=='RWC',]
soilC_30_60_1993[soilC_30_60_1993$Treatment=='OMT',]
soilC_30_60_2012[soilC_30_60_2012$Treatment=='OMT',]

t.test(soilC_0_15_1993$soilC[soilC_0_15_1993$Treatment=='CWT'], soilC_0_15_2012$soilC[soilC_0_15_2012$Treatment=='CWT'], paired = TRUE)
t.test(soilC_60_100_1993$soilC[soilC_60_100_1993$Treatment=='CWT'], soilC_60_100_2012$soilC[soilC_60_100_2012$Treatment=='CWT'], paired = TRUE)
...
deltaC_19yrs <- soilC_2012[,3:6] - soilC_1993[,3:6]
deltaC_19yrs$Plot <- row.names(deltaC_19yrs)
deltaC_19yrs$Treatment <- soilC_1993$Treatment
View(deltaC_19yrs)
lapply(deltaC_19yrs[,1:4], summary)
lapply(deltaC_19yrs[,1:4], function(x) tapply(x[!is.na(x)], deltaC_19yrs$Treatment[!is.na(x)], summary))
