...
tiff(file = file.path(FiguresDir, 'CalAg', 'perennial_crops_SHR7_rel_area_v2.tif'), family = 'Times New Roman', width = 6.5, height = 4, pointsize = 12, units = 'in', res=800, compression='lzw')
par(mar=c(3, 4.5, 4.5, 0.5), xpd=TRUE)
