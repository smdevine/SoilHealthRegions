...
FiguresDir <- 'C:/Users/smdevine/Desktop/post doc/soil health/Figures/valley_final'
...
kssl_horizons_SHR.slab <- slab(kssl_horizons_SHR, SHR7name ~ clay + ph_h2o + ec_12pre + oc_est, slab.structure = 1)
