...
tiff(file = file.path(FiguresDir, 'FINAL', 'Fig2.tif'), family = 'Times New Roman', width = 6.5, height = 3.5, pointsize = 11, units = 'in', res=800, compression = 'lzw')
...
mtext(text='Number of soil health regions in conceptual model', side=1, line=2.25)
mtext(text='Number of significant group contrasts, validation data', side=2, line=2.25, at=15)
