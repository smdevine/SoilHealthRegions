...
df_combined2 <- kerri_points_30cm[!is.na(kerri_points_30cm$cluster_7), c('clay_30cm', 'om_30cm', 'bd_30cm', 'pH_H2O_30cm', colnames(kerri_points_30cm)[grepl('cluster_', colnames(kerri_points_30cm))])]
...
compare_region_means(df=df_combined, names=clus_7_names, cluster_no=7, y='pH_H2O_30cm', alpha = 0.05)
...
lines(x=3:9, y=100*contrast_summary$bd/contrast_summary$contrast_no, col='chocolate4', type='b', pch=21, bg='chocolate4')
...
abline(h=5, lty=2)
legend('topright', legend = c('pH', 'Clay', 'CEC', 'LEP', 'OM', 'EC', 'BD', 'Null'), col=c('red3', 'grey', 'blue', 'darkviolet', 'black', 'darkorange', 'chocolate4', 'black'), lty=c(rep(1, 7), 2), pch=c(rep(21, 7), NA), pt.bg=c('red3', 'grey', 'blue', 'darkviolet', 'black', 'darkorange', 'chocolate4', 'black', NA), ncol = 2)
dev.off()
