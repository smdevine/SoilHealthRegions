...
tiff(file = file.path(FiguresDir, 'v2', 'validation plots', 'sig_group_contrasts_3to9_not_rel.tif'), family = 'Times New Roman', width = 6.5, height = 3.5, pointsize = 11, units = 'in', res=800, compression = 'lzw')
